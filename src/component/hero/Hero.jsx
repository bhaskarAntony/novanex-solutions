  ...
  return (
   <section className='hero p-3 p-md-5'>
       ...
       <span className="text-main"> Digital Transformation & IT Services</span>
          ...
          <h2 className='fs-4'>Empower Your Business with Innovative IT Solutions <br /> and Digital Transformation Services</h2>
        ...
        <br />
        <a href='#services' className="main-btn px-5 p-3 btn-100">Explore Our Services</a>
        </div>
